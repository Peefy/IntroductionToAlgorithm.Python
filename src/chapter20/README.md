---
layout: post
title: "用Python实现的斐波那契堆"
description: "用Python实现的斐波那契堆"
categories: [Python]
tags: [python]
redirect_from:
  - /2018/06/17/
...
斐波那契堆不涉及删除元素的可合并堆操作仅需要O(1)的平摊时间,这是斐波那契堆的优点
...
[Github Code](https://github.com/Peefy/IntroductionToAlgorithm.Python/blob/master/src/chapter20)
